...
###    simulation function     ###
##################################
processAvatar = function(avatars, initialDose, protocol, numDaysToSimulate, maxDose, numReplicates, maxTime=24, av_per, av_index) {
...
source("adjustment.maintenance.protocols.library.R")
source("initial.dosing.library.R")
