...
av_out_array = processAvatar(avatars=av_sub, protocol="wilson_coumagen_pharm", initialDose=16, numDaysToSimulate=90, maxDose=15, numReplicates=numReplicates, maxTime=24, rseed=rand_sub)

save(av_out_array, file=paste("Coumagen_pharm_", av_index, ".RData", sep = ""))
