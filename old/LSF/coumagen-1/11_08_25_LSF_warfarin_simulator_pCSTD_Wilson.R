...
# bsub -q shared_2h -J "cstd[1-990]" -o "/home/vaf3/avatars/Coumagen/out/output.%J.%I" -R "rusage[mem=200]" -u vfusaro@hms.harvard.edu R CMD BATCH --vanilla --slave 11_08_18_LSF_warfarin_simulator_pCPGx.R simoutput.%J.%I
...
av_out_array = processAvatar(avatars=av_sub, protocol="wilson_coumagen_standard", initialDose=10, numDaysToSimulate=90, maxDose=15, numReplicates=numReplicates, maxTime=24, rseed=rand_sub)
