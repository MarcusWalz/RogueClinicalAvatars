...
av_out_array = processAvatar(avatars=av_sub, protocol="wilson", initialDose=10, numDaysToSimulate=90, maxDose=15, numReplicates=numReplicates, maxTime=24, rseed=rand_sub)

save(av_out_array, file=paste("Coumagen_standard_wilson_", av_index, ".RData", sep = ""))
